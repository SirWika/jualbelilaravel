        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3>@php
    $targetId = 1;
    $targetProduct = $data_another->where('id_produk', $targetId)->first();
@endphp
        @if($targetProduct)
                        {{ $targetProduct->nama }}
        ...
        @endif</p>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" value="1" id="counter">
                            <div class="input-group-btn">
                        ...
                        <button class="btn btn-primary px-3" href="/cart"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
...
<script>
    function incrementValue() {
        var inputElement = document.getElementById('counter');
